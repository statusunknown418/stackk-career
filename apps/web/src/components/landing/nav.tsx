...
export function LandingNav() {
	return (
		<header className="sticky top-4 z-50 mx-auto mt-4 w-full max-w-[1200px] px-4">
			<nav className="flex items-center gap-6 rounded-full border border-foreground/10 bg-background/70 py-2 pr-2 pl-3 shadow-[var(--shadow-nav)] backdrop-blur-xl backdrop-saturate-150">
