...
DROP INDEX "user_subscriptions_provider_preapproval_idx";--> statement-breakpoint
ALTER TABLE `fileMetadata` ALTER COLUMN "metadata" TO "metadata" text;--> statement-breakpoint
...
ALTER TABLE `messages` ALTER COLUMN "toolMeta" TO "toolMeta" text;--> statement-breakpoint
ALTER TABLE `messages` ALTER COLUMN "object" TO "object" text;--> statement-breakpoint
ALTER TABLE `resume_analyses` ALTER COLUMN "object" TO "object" text;--> statement-breakpoint
ALTER TABLE `resumes` ALTER COLUMN "aiMetadata" TO "aiMetadata" text;--> statement-breakpoint
ALTER TABLE `billing_events` ALTER COLUMN "payload" TO "payload" text;