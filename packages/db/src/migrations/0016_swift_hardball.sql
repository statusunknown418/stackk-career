...
ALTER TABLE `resumes` ALTER COLUMN "displayName" TO "displayName" text NOT NULL DEFAULT 'CV sin título';--> statement-breakpoint
...
ALTER TABLE `resumes` ALTER COLUMN "title" TO "title" text NOT NULL DEFAULT 'CV sin título';--> statement-breakpoint
ALTER TABLE `resumes` ADD `targetRole` text;